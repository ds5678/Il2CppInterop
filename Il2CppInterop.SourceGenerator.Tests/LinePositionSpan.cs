...
internal readonly record struct LinePositionSpan(int StartLine, int StartColumn, int EndLine, int EndColumn)
{
    public static LinePositionSpan FindInSource(string source, string target, int index = 0)
    {
        ...
        return new LinePositionSpan(startLine, startColumn, endLine, endColumn);
    }
}
